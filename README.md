...
- New home corners: Watch nights keep films or series, whether she watches alone or together, venue, time, snacks, and a chosen title; Our Adventure Book keeps photo pages for memories and future plans; Wall of Lyrics keeps user-entered words, paper/lettering styles, and saved ordering; Little loves keeps small, dear things as polaroid stories; Moon days tracks her cycle as periods around a moon wheel with a gentle prediction (29 days usual), alongside a simple weigh-in log. See [section behaviour](docs/ROOM_SECTIONS.md).
